...
void crate_track_bars() {
    ...
    cv::createTrackbar("weight1", "low_passed", &weight1, weight_max, on_trackbar);
    cv::createTrackbar("weight2", "high_passed", &weight2, weight_max, on_trackbar);
}