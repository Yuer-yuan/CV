...
const static std::string dog = "/home/bill/mypro/CV/lab1-hybrid-image/gui/res/dog.jpg";
const static std::string cat = "/home/bill/mypro/CV/lab1-hybrid-image/gui/res/cat.jpg";
const static std::string donkey = "/home/bill/mypro/CV/lab1-hybrid-image/gui/res/donkey1.jpg";
const static std::string zebra = "/home/bill/mypro/CV/lab1-hybrid-image/gui/res/zebra1.jpg";
...
const int ksize_max = 99, sigma_max = 99, weight1_max = 10, weight2_max = 10;
...
cv::Mat hybrid_img(const cv::Mat &img1, const cv::Mat &img2, int ksize1, double sigma1, int ksize2, double sigma2, double weight1, double weight2) {
    ...
    // cv::add_weighted(img1_g1, img2_g2, dst);
    cv::addWeighted(img1_g1, 1.0, img2_g2, 1.0, 0.0, dst);
