...
const static std::string dog = "/home/bill/mypro/CV/lab1-hybrid-image/gui/res/dog.png";
const static std::string cat = "/home/bill/mypro/CV/lab1-hybrid-image/gui/res/cat.png";
...
cv::Mat hybrid_img(const cv::Mat &img1, const cv::Mat &img2, int ksize1, double sigma1, int ksize2, double sigma2) {
    ...
    cv::imshow(wnd_name, img1_g1);
    // cv::imshow(wnd_name, img2_g2);
