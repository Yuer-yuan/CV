...
int sigma1_ = sigma1, sigma2 = sigma2;
...
int main()
{
    ...
    cv::createTrackbar("sigma1", "hybrid", &sigma, ksize_max, on_trackbar);
    cv::createTrackbar("ksize2", "hybrid", &ksize1, ksize_max, on_trackbar);
