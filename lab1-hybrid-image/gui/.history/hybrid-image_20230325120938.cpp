...
const cv::Mat img1 = cv::imread(resources["squirrel"]);   // to be applide by low pass filter
const cv::Mat img2 = cv::imread(resources["bunny"]);      // to be applied by high pass filter
