...
const static std::map< int, std::pair<std::string, std::string> > pairs {
    {0, {resource_dir + "squirrel1.png", resource_dir + "bunny1.png"}},
    {1, {resource_dir + "dog.jpg", resource_dir + "cat.jpg"}},
    {2, {resource_dir + "donkey1.jpg", resource_dir + "zebra1.jpg"}},
};

const cv::Mat img1 = cv::imread(pairs[PAIR].first);
const cv::Mat img2 = cv::imread(pairs[PAIR].second);
