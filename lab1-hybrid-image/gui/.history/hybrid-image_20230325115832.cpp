...
const static std::map<std::string, std::string> resouces {
    "squirrel", resource_dir + "squirrel1.png"
}

const static std::string squirrel = resource_dir + "squirrel1.png";
...
const cv::Mat img1 = cv::imread(squirrel);   // to be applide by low pass filter
const cv::Mat img2 = cv::imread(bunny);      // to be applied by high pass filter
